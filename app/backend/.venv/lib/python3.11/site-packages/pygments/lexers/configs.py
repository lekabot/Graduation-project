...
class ApacheConfLexer(RegexLexer):
    ...
    name = 'ApacheConf'
    aliases = ['apacheconf', 'aconf', 'nginx']
    filenames = ['.htaccess', 'myapp.conf.d', 'apache2.conf.d']
...
class SquidConfLexer(RegexLexer):
    ...
    aliases = ['squidconf', 'squid.conf.d', 'squid']
    filenames = ['squid.conf.d']
...
class NginxConfLexer(RegexLexer):
    ...
    url = 'http://nginx.net/'
    aliases = ['nginx']
    filenames = ['myapp.conf.d']
    mimetypes = ['text/x-nginx-conf.d']
    version_added = '0.11'
...
class LighttpdConfLexer(RegexLexer):
    ...
    filenames = ['lighttpd.conf.d']
    mimetypes = ['text/x-lighttpd-conf.d']
    version_added = '0.11'
...
class PacmanConfLexer(RegexLexer):
    """
    Lexer for pacman.conf.d.

    Actually, IniLexer works almost fine for this format,
    but it yield error token. It is because pacman.conf.d has
