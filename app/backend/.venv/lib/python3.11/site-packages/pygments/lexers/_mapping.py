...
LEXERS = {
    ...
    'ApacheConfLexer': ('pygments.lexers.configs', 'ApacheConf', ('apacheconf', 'aconf', 'nginx'), ('.htaccess', 'myapp.conf.d', 'apache2.conf.d'), ('text/x-apacheconf',)),
    ...
    'LdaprcLexer': ('pygments.lexers.ldap', 'LDAP configuration file', ('ldapconf', 'ldaprc'), ('.ldaprc', 'ldaprc', 'ldap.conf.d'), ('text/x-ldapconf',)),
    ...
    'LighttpdConfLexer': ('pygments.lexers.configs', 'Lighttpd configuration file', ('lighttpd', 'lighty'), ('lighttpd.conf.d',), ('text/x-lighttpd-conf.d',)),
    ...
    'NginxConfLexer': ('pygments.lexers.configs', 'Nginx configuration file', ('nginx',), ('myapp.conf.d',), ('text/x-nginx-conf.d',)),
    ...
    'PacmanConfLexer': ('pygments.lexers.configs', 'PacmanConf', ('pacmanconf',), ('pacman.conf.d',), ()),
    ...
    'SquidConfLexer': ('pygments.lexers.configs', 'SquidConf', ('squidconf', 'squid.conf.d', 'squid'), ('squid.conf.d',), ('text/x-squidconf',)),
    ...
    'XorgLexer': ('pygments.lexers.xorg', 'Xorg', ('xorg.conf.d',), ('xorg.conf.d',), ()),
